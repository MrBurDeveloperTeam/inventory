          ...
          <motion.div
                  ...
                  >
                    ...
                    <div className="p-2 border-b border-slate-100">
                      ...
                      >
                        <div className="w-7 h-7 rounded-xl bg-violet-50 flex items-center justify-center shrink-0 invisible">
                      ...
                      <button
                        ...
                        className="w-full flex items-center gap-3 px-4 py-3.5 hover:bg-slate-50 rounded-2xl transition-all group text-left"
                      >
                        <div className="w-7 h-7 rounded-xl bg-sky-50 flex items-center justify-center shrink-0 invisible">
                      ...
                      >
                        <div className="w-7 h-7 rounded-xl bg-blue-50 flex items-center justify-center shrink-0 invisible">
                      ...
                      <button
                        ...
                        className="w-full flex items-center gap-3 px-4 py-3.5 hover:bg-slate-50 rounded-2xl transition-all group text-left"
                      >
                        <div className="w-7 h-7 rounded-xl bg-slate-100 flex items-center justify-center shrink-0 invisible">
