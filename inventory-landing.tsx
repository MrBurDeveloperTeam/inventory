...
const features = [
  ...
  },
  {
    ...
    description:
      'Separate supplies by treatment room and monitor room-level quantities accurately.',
  },
  {
    icon: Sparkles,
  ...
  return (
    <main className="inventory-landing">
      <nav className="inventory-nav">
        <a className="inventory-brand" href="#top">
          <img
            src={`${import.meta.env.BASE_URL}icons/Snabbb-Teal.png`}
            alt="Snabbb"
          />
          <span>Inventory</span>
        </a>
      ...
      >
        ...
        <div className="inventory-hero-preview">
          ...
          >
            <div className="clinic-preview-topbar">
              <div className="clinic-preview-title">
                <Map size={18} />
                <strong>Interactive Clinic</strong>

                <span className="preview-sync-badge">
                  <span />
                  Live &amp; Synced
                </span>
              </div>
            ...
            <div className="clinic-preview-content">
              <div className="preview-dashboard-row">
                <div>
                  <small>Clinic overview</small>
                  <h3>Know where your stock is.</h3>
                </div>
              ...
              <div className="clinic-map">
                <div className="map-room room-a">
                  <span>Room 1</span>
                  <b>15 SKU</b>
                </div>

                <div className="map-room room-b">
                  <span>Room 4</span>
                  <b>8 SKU</b>
                </div>

                <div className="map-room room-c">
                  <span>Room 6</span>
                  <b>2 SKU</b>
                </div>
      ...
      <motion.section
        className="inventory-stat-strip"
        initial="hidden"
        whileInView="visible"
      ...
      >
        ...
        <button
          className="inventory-primary-button light-button"
          onClick={handleGetStarted}
        >
          Get Started
          <ArrowRight size={18} />
